...
<div class="br-pageheader">
    <nav class="breadcrumb pd-0 mg-0 tx-12">
      ...
      <span class="breadcrumb-item active">Supplier Add</span>
    </nav>
  </div><!-- br-pageheader -->
        ...
        <div class="card">
          @if(Session('status'))
            ...
            <div class="card-header d-flex justify-content-between">
                <h4>Add Supplier</h4>
                <a href="{{route('supplier.supplier-list')}}" class="btn btn-sm btn-info float-right mt-1"> Supplier List</a>
            </div>
            <div class="card-body  ">
                    ...
                    <div class="row mg-b-25 ">
                      ...
                      <div class="col-lg-4 " ><label for="exampleFormControlFile1">Photo Upload</label>
                        <div class="form-group border d-flex justify-content-between ">
                                <input type="file" name="supplier_image" class="form-control-file" id="exampleFormControlFile1" style="height: 40px">
                        </div>
                      </div><!-- col-4 -->
                      <div class="col-lg-4">
                        <div class="form-group">
